...
Since the strain change of the piezoelectric sensor is an analogue input, and a handpan has at least 8 notes, an Arduino Mega 2560 board with 16 analog inputs and 54 digital input/output pins was used, as shown in Figure 6[^11-14].
